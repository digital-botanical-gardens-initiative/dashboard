...
with ProgressBar():
    ...
    fig_chemo = px.scatter(umap_df, x=0, y=1, color=2,
                           title='UMAP projection of the molecular dataset', template='simple_white',
                           width=1300,height=1000)
    fig_chemo.update_layout(legend_title='Class')
